...
if [[ $os_version == *"armv7l"* ]] || [[ $os_version == *"raspi"* ]]; then
  ...
  sshpass -p $TARGET_SERVER_PASSWORD scp -P $TARGET_SERVER_PORT -r /home/$SSH_USERNAME/nginx/service-url-blue.inc $TARGET_SERVER_USERNAME@$TARGET_SERVER_IP:/home/$TARGET_SERVER_USERNAME/ && echo "Transfer successful!" || echo "Transfer failed"
  sshpass -p $TARGET_SERVER_PASSWORD scp -P $TARGET_SERVER_PORT -r /home/$SSH_USERNAME/nginx/service-url-green.inc $TARGET_SERVER_USERNAME@$TARGET_SERVER_IP:/home/$TARGET_SERVER_USERNAME/ && echo "Transfer successful!" || echo "Transfer failed"
  ...
  echo "Transferring Nginx data... [6/7]"
  scp -i $TARGET_SERVER_KEYFILE_DIR -P $TARGET_SERVER_PORT -r /home/$SSH_USERNAME/nginx/service-url-blue.inc $TARGET_SERVER_USERNAME@$TARGET_SERVER_IP:/home/$TARGET_SERVER_USERNAME/ && echo "Transfer successful!" || echo "Transfer failed"
  scp -i $TARGET_SERVER_KEYFILE_DIR -P $TARGET_SERVER_PORT -r /home/$SSH_USERNAME/nginx/service-url-green.inc $TARGET_SERVER_USERNAME@$TARGET_SERVER_IP:/home/$TARGET_SERVER_USERNAME/ && echo "Transfer successful!" || echo "Transfer failed"
